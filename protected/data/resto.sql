...
--
-- Host: localhost
-- Generation Time: Sep 22, 2013 at 02:15 PM
...
(4, 'Salad Buah', 3, NULL, 15000, 'Campuran bereneka macam buah segar yang dihidangkan bersama dengan perasan jeruk lemon dan madu'),
...
INSERT INTO `pengguna` (`id`, `username`, `password`, `saltPassword`, `email`, `tgl_daftar`, `level_id`) VALUES
(5, 'admin', '380ca5badbf3c30286aac540cbe9a667', '523831049ff517.72662814', 'admin@localhost.com', '2013-09-17 10:37:56', 9),
(6, 'kasir', 'd156be8273d07708a3b1c3a8a9d49c46', '523db90545c0b7.56376652', 'kasir@localhost', '2013-09-17 10:48:37', 1),
(7, 'dapur', '3594422a330b2bfb84cfbc4f3e2cbdab', '523833da9ec241.10947470', 'dapur@localhost', '2013-09-17 10:50:02', 2),
(8, 'pelayan', 'dce805124438cbdd1c99d502874389b3', '523833f0c7bb35.12959465', 'pelayan@localhost', '2013-09-17 10:50:24', 3);
...
(2, 1, '2013-09-14', 'Zaskia Gothic', 2, 70000, 'Y'),
...
INSERT INTO `pesanan_detail` (`id`, `pesanan_id`, `menu_id`, `harga`, `status`, `catatan`, `batal`) VALUES
(1, 2, 2, 25000, 1, 'gak pedes', 'Y'),
(2, 2, 3, 30000, 3, '', 'N'),
(4, 2, 1, 40000, 1, '', 'N'),
(5, 3, 2, 25000, 1, '', 'N'),
(6, 3, 4, 15000, 1, '', 'N'),
...
CREATE TABLE IF NOT EXISTS `transaksi` (
  ...
  `pegawai_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `kasir` (`pegawai_id`),
  KEY `pesanan1` (`pesanan_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
ALTER TABLE `transaksi`
  ...
  ADD CONSTRAINT `pesanan1` FOREIGN KEY (`pesanan_id`) REFERENCES `pesanan` (`id`);
